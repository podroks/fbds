...
const focusVisibleClass =
  'has-[input:focus-visible]:outline-2 has-[input:focus-visible]:outline-fbds-primary has-[input:focus-visible]:outline-offset-2';
...
<template>
  ...
  >
    <div
      class="h-10 w-full rounded-md fbds-font-label"
